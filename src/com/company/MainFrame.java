...
public class MainFrame extends JFrame {
    ...
    MainFrame(Double[] coefficients) {
        ...
        Action saveToCVSAction = new AbstractAction("Сохранить данные в CSV") {
            public void actionPerformed(ActionEvent event) {
                if (fileChooser == null) {
                    fileChooser = new JFileChooser();
                    fileChooser.setCurrentDirectory(new File("."));
        ...
        Action searchFromToAction = new AbstractAction("Найти из диапазона") {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                searchTo.setMaximumSize(searchFrom.getPreferredSize());
                ...
                diapazonBox.add(Box.createVerticalGlue());
                JOptionPane.showMessageDialog(MainFrame.this, diapazonBox, "" + "Найти из диапазона", JOptionPane.QUESTION_MESSAGE);
                renderer.setdiap(searchFrom.getText(),searchTo.getText());
                getContentPane().repaint();
            }
        };
        ...
        Action aboutProgramAction=new AbstractAction("О программе") {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                ImageIcon icon = new ImageIcon("src/com/company/photo.jpeg");
        ...
        informationItem=aboutMenu.add(aboutProgramAction);
